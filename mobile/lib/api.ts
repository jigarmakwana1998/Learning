...
export type LearningRun = { id: string; harness: AgentHarness; research: { topic: string; sources: Source[]; visited_sources?: SourceVisit[]; coverage?: ResearchCoverage[]; stop_reason?: "coverage_satisfied" | "budget_exhausted" | "no_new_evidence" | null; warnings?: string[]; research_stats?: ResearchStats }; curriculum: CourseModule[]; assessment: { quiz: QuizItem[]; quiz_items?: QuizItem[]; assignment: AssignmentPrompt; project: string }; sessions: Record<string, string> };
